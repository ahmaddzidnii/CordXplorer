...
export const Navbar = () => {
  ...
  return (
    <header className="max-w-screen h-[72px]  z-[1030] bg-background sticky top-0  w-full p-6 border-b shadow-sm backdrop-blur-2xl supports-[backdrop-filter]:bg-background/90 dark:supports-[backdrop-filter]:bg-background/60">
