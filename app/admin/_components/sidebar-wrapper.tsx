  ...
  return (
    <div className="min-h-screen">
      <div className="flex">
        ...
        <aside
          className={cn(
            "w-56 pt-5 px-4 sticky top-0 border-e-2 max-h-screen shadow-lg flex-col items-center justify-between hidden md:flex"
          )}
        >
        ...
        <div className="mx-3 w-full min-h-screen">{children}</div>
      </div>
    </div>
  );
};
